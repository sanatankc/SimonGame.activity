...
var _im = __webpack_require__(29);
...
var cardsFalseState = [false, false, false, false];
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.freq = [329.63, 261.63, 220, 164.81];
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    key: 'glowCards',
    value: function glowCards() {
      var _this2 = this;

      var cardsToGlow = this.state.cardsToGlow;
      ...
      var cardToGlow = cardsToGlow[0];
      this.sound.play(this.freq[cardToGlow]);
      var glowingCards = _im2.default.insert(cardsFalseState, cardToGlow, true);
      cardsToGlow.shift();
      this.setState({
        cardGlow: glowingCards,
        cardsToGlow: cardsToGlow
      }, function () {
        setTimeout(function () {
          _this2.setState({ cardGlow: cardsFalseState }, function () {
            _this2.sound.pause();
            setTimeout(_this2.glowCards.bind(_this2), 200);
          });
        }, 500);
      });
    }
    ...
    key: 'handleStart',
    value: function handleStart(gameState) {
      var _this3 = this;

      this.setState({
        gameState: [].concat(_toConsumableArray(gameState)),
        cardsToGlow: [].concat(_toConsumableArray(gameState))
      }, function () {
        _this3.glowCards();
      });
    }
    ...
    key: 'handleCardDown',
    value: function handleCardDown(e) {
      e.preventDefault();
      if (this.state.clickIsAllowed) {
        var glowingCards = _im2.default.insert(cardsFalseState, e.target.dataset.key, true);
        this.setState({
          cardGlow: glowingCards,
    ...
    key: 'handleCardUp',
    value: function handleCardUp(e) {
      var _this4 = this;

      e.preventDefault();
      if (this.state.clickIsAllowed) {
        var cardIndex = e.target.dataset.key;
        this.sound.pause();
        this.setState(function (prevState) {
          return {
            cardGlow: cardsFalseState,
            shouldHandleMouseLeave: false,
            userCards: _im2.default.push(prevState.userCards, +cardIndex)
          };
        }, function () {
          return _this4.validateCards(_this4.state.userCards);
        });
      }
    }
  }, {
    key: 'validateCards',
    value: function validateCards(cards) {
      var _this5 = this;

      var allElementsEqual = cards.every(function (card, i) {
        return _this5.state.gameState[i] === card;
      });
      var isSameLength = this.state.gameState.length === cards.length;

      if (allElementsEqual && isSameLength) {
        this.onWin();
      } else if (allElementsEqual && !isSameLength) {} else {
    ...
    value: function onWin() {
      ...
      this.setState(function (prevState) {
        ...
        setTimeout(function () {
          return _this6.handleStart([].concat(_toConsumableArray(_this6.state.gameState), [Math.floor(Math.random() * 4)]));
        }, 500);
      });
    }
  }, {
    ...
    value: function onLose() {
      ...
      if (this.state.strict) {
        ...
        this.setState({
          ...
          setTimeout(function () {
            return _this7.handleStart([].concat(_toConsumableArray(_this7.state.gameState)));
          }, 500);
        });
      }
    }
    ...
    key: 'losingAnimation',
    value: function losingAnimation(callback) {
      var _this8 = this;

      var allCardsGlow = [true, true, true, true];
      this.setState({
      ...
      setTimeout(function () {
        _this8.setState({ cardGlow: cardsFalseState }, callback);
        _this8.sound.pause();
      }, 2000);
    }
  }, {
    key: 'handleCardLeave',
    value: function handleCardLeave(e) {
      e.preventDefault();
    ...
    value: function reset() {
      ...
      this.setState({
        ...
        setTimeout(function () {
          return _this9.handleStart([Math.floor(Math.random() * 4)]);
        }, 500);
      });
    }
  }, {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _App.Mask,
                null,
                this.state.cardColor.map(function (color, i) {
                  return _react2.default.createElement(_App.Card, {
                    color: color,
                    key: i,
                    shouldGlow: _this10.state.cardGlow[i],
                    'data-key': i,
                    'data-freq': _this10.freq[i],
                    onMouseDown: _this10.handleCardDown.bind(_this10),
                    onMouseUp: _this10.handleCardUp.bind(_this10),
                    onMouseLeave: _this10.handleCardLeave.bind(_this10),
                    onTouchStart: _this10.handleCardDown.bind(_this10),
                    onTouchEnd: _this10.handleCardUp.bind(_this10),
                    onTouchMove: _this10.handleCardLeave.bind(_this10)
                  });
                })
              ),
              _react2.default.createElement(
...
var _stylis = __webpack_require__(35);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(32)(module)))
...
var insert = function insert(arr, index, item) {
  var cpArr = [].concat(_toConsumableArray(arr));
  cpArr[index] = item;
  return cpArr;
};

var remove = function remove(arr, index) {
  var cpArr = [].concat(_toConsumableArray(arr));
  cpArr.splice(index, 1);
  return cpArr;
};

var push = function push(arr, item) {
  return [].concat(_toConsumableArray(arr), [item]);
};
exports.default = { insert: insert, remove: remove, push: push };
...
var _ToolBarButton = __webpack_require__(40);
  ...
  _createClass(Toolbar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_ToolBarButton.Button, {
          title: this.state.isStartEverClicked ? 'Restart' : 'Start',
          icon: this.state.isStartEverClicked ? 'replay.svg' : 'play.svg',
          onClick: function onClick() {
            !_this2.state.isStartEverClicked && _this2.setState({ isStartEverClicked: true });
            _this2.props.onStartClick();
          } }),
        _react2.default.createElement(_ToolBarButton.Button, {
...
exports.LevelCount = exports.ButtonsContainer = exports.ControlsContainer = exports.Container = exports.InnerMask = exports.Card = exports.Mask = exports.MainCircle = exports.Main = undefined;
...
var _boxShadow3d = __webpack_require__(42);

var _boxShadow3d2 = _interopRequireDefault(_boxShadow3d);

var _shadeColor = __webpack_require__(43);
...
var flexCenter = (0, _styledComponents.css)(_templateObject);

var Main = exports.Main = _styledComponents2.default.div(_templateObject2, flexCenter);

var MainCircle = exports.MainCircle = _styledComponents2.default.div(_templateObject3, flexCenter, (0, _boxShadow3d2.default)(13, '#c7d6da'));

var Mask = exports.Mask = _styledComponents2.default.div(_templateObject4);

var Card = exports.Card = _styledComponents2.default.div(_templateObject5, function (props) {
  return props.color;
}, function (props) {
  return props.shouldGlow ? 'rgba(0, 0, 0, 0)' : 'rgba(0, 0, 0, 0.3)';
});

var InnerMask = exports.InnerMask = _styledComponents2.default.div(_templateObject6, flexCenter);

var Container = exports.Container = _styledComponents2.default.div(_templateObject7, flexCenter);

var ControlsContainer = exports.ControlsContainer = _styledComponents2.default.div(_templateObject8, flexCenter);

var ButtonsContainer = exports.ButtonsContainer = _styledComponents2.default.div(_templateObject9, flexCenter);

var LevelCount = exports.LevelCount = _styledComponents2.default.div(_templateObject10);
...
var boxShadow3d = function boxShadow3d(offset, color) {
  var css = '';
